...
/// implementeaza sablonul de proiectare Template Method;
// pot inlucui solutia propusa cu un Factori
public abstract class AbstractFileRepository<ID, E extends Entitate<ID>> extends InMemoryRepository<ID, E> {
    String fileName;
    ...
    protected void writeToFile(E entity) {
        ...
        //The "BufferedWriter" class of java supports writing a chain of characters output stream
